    ...
    <div class="right">
        <div class="inner">
            ...
            <div class="directory-tags"><center>
                <div class="tag"><a href=""><i class="pe-7s-angle-left"></i>Anterior</a></div>
                    <div class="tag"><a href="">Siguiente<i class="pe-7s-angle-right"></i></a></div></center>
            ...
            <div class="directory-list row">
                <?php for($i = 0; $i < $evento_page->size; $i++){ ?>
                <div class="col-sm-6">
